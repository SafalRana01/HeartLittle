...
SECRET_KEY = 'django-insecure-&^--^y$&^u^d^*iule(1iv)3scmi!jsa_xi!_-0r_rua^s#8ej'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Updated to use Path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'varungrg10@gmail.com'  
EMAIL_HOST_PASSWORD= 'zgoiwkattxjpihmn'
DEFAULT_FROM_EMAIL = 'varungrg10@gmail.com' 
